...
spec file. Python, Node.js, C, Java, and Go are included.
...
- **Languages** - these are defined as configuration files. Each is a small
  ...
  them. See [`docs/authoring-languages.md`](docs/authoring-languages.md) for the
  full `image.yml` / `tests.yml` field reference.
